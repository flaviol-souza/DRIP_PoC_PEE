...
void fleet_init() {
    ...
    g_n = 1; g_focus = 0; g_debug_slot = 0;
    ...
    // N = 1 with the dump ON == the original single-drone PoC behaviour.
    drip_debug_set_enabled(true);
    fleet_restagger(millis());
